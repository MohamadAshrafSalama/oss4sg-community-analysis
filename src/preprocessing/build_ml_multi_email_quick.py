#!/usr/bin/env python3
"""
Quick version: Process projects and save incrementally
"""
...
with open(output_file, "w") as f:
    f.write("=" * 100 + "\n")
    f.write("ML Contributors with Multiple Emails\n")
    f.write("=" * 100 + "\n\n")
...
for i, proj_file in enumerate(projects, 1):
    ...
    if i % 10 == 0:
        print(f"  {i}/{len(projects)} projects processed... ({len(all_multi_email)} multi-email contributors found)")
...
print(f"\nTop 5 by email count:")
for i, contrib in enumerate(all_multi_email[:5], 1):
